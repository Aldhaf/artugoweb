...
@section('title', 'Add New Defect Problem')
@section('content')
<div>
      ...
      <div class="col-md-6">
        <div class="box box-solid">
          ...
          <div class="box-body">
            ...
            <form class="" action="{{ url('artmin/problem-defect/add-problem-defect-process') }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <label>Defect</label>
                <input type="text" class="form-control" name="defect" value="{{ old('defect') }}" placeholder="Defect">
              ...
              <div class="form-group">
                <button class="btn btn-primary"><i class="fa fa-plus"></i> Add New Defect Problem</button>
              </div>
