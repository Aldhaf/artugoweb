...
@section('title', 'Add New Action Problem')
@section('content')
<div>
      ...
      <div class="col-md-6">
        <div class="box box-solid">
          ...
          <div class="box-body">
            ...
            <form class="" action="{{ url('artmin/problem-action/add-problem-action-process') }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <label>Action</label>
                <input type="text" class="form-control" name="action" value="{{ old('action') }}" placeholder="Action">
              ...
              <div class="form-group">
                <button class="btn btn-primary"><i class="fa fa-plus"></i> Add New Action Problem</button>
              </div>
