        ...
        <div class="row">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="w-100">
                    ...
                    <div class="box box-solid">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="0" <?php if (old('status',$article->status) == 0) echo "selected"; ?>>Draft</option>
                                        <option value="1" <?php if (old('status',$article->status) == 1) echo "selected"; ?>>Publish</option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-9 form-group">
                                    <label>Slug</label>
                                    <input type="text" class="form-control" name="slug" id="url" value="{{ old('slug',$article->slug) }}">
                                    @if ($errors->has('slug'))
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control select2" name="category">
                                        ...
                                        <?php foreach ($category as $cat) : ?>
                                            <option value="<?= $cat->id ?>" <?php if (old('category',$article->category) == $cat->id) echo "selected"; ?>><?= $cat->title ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-control" name="reader">
                                        <option value="customer" <?php if (old('status',$article->reader) == 'customer') echo "selected"; ?>>Customer</option>
                                        <option value="employee" <?php if (old('status',$article->reader) == 'employee') echo "selected"; ?>>Employee</option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="meta_desc">{{ old('meta_desc',$article->meta_desc) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="meta_tags" value="{{ old('meta_tags',$article->meta_tags) }}">
                            ...
                            <div class="form-group">
                                <label>Content</label>
                                <textarea type="text" class="form-control editor" name="content">{{ old('content', $article->content) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="image" id="image" value="<?= old('image', $article->image) ?>"/>
                                @if ($errors->has('image'))
                                <label class="control-label input-error" for="inputError"><i class="fa fa-exclamation-circle"></i> {{ $errors->first('image') }}</label>
                                @endif
                            </div>
                            <div class="form-group">
                                <img id="preview_image" class="preview" src="<?= old('image', $article->image) ?>"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="pdf" id="pdf" value="<?= old('image', $article->pdf) ?>"/>
                                @if ($errors->has('pdf'))
                                <label class="control-label input-error" for="inputError"><i class="fa fa-exclamation-circle"></i> {{ $errors->first('pdf') }}</label>
                                @endif
                            </div>
                            <div class="form-group">
                                <embed id="preview_pdf" style="width:100%; height: <?php echo old('image', $article->pdf) == '' ? '0px' : '1020px'; ?>; border: 1px solid rgb(226 232 240/var(--tw-border-opacity));" src="<?= old('image', $article->pdf) ?>" type="application/pdf" />
                            </div>
                            @endif
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <center>
                            <button class="btn btn-primary"><i class="fa fa-save"></i> Update Post</button>
                        </center>
                    </div>
                </div>
            </form>
