        ...
        <div class="box box-solid">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <a href="{{ url('artmin/promotion/cashback/settings/add-period') }}">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('artmin/promotion/cashback/settings/detail/'.$val->id) }}">
...
<script>
  ...
  $(document).on('submit', '.fdata', function(e) {
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          let url = '{{ url("artmin/promotion/cashback/settings/period") }}';
